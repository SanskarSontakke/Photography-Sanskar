            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2">
                    <h2 className="text-4xl md:text-6xl font-bold uppercase font-oswald mb-8 leading-tight">
                        <TextReveal>Capturing</TextReveal> <br />
                        <span className="text-gray-500"><TextReveal delay={0.1}>The Unseen</TextReveal></span>
                    </h2>
                </div>
                    ...
                    <FadeIn delay={0.4} direction="up">
                        <div className="mt-8 pt-8 border-t border-gray-200">
                            <div className="grid grid-cols-3 gap-4 text-center">
                                <div>
                                    <span className="block text-3xl font-bold font-oswald">
